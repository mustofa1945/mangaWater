...
<template>
    <div :class="`text-gray-400 hover:text-gray-100 duration-200 transition-all ${canHover ? 'trigger' : 'no-trigger'} text-lg relative `" @click="runDropdown(data.id)"
        ...
        <div
            ...
            <Link
                :class="`pl-3 box-border ${data.property.childWidth} text-[${data.property.size}px] hover:border-sky-600 hover:bg-sky-300/10 hover:text-sky-700 duration-200 rounded-xl`"
