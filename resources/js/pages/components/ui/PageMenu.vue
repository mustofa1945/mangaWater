...
<template>
    <div
        :class="`Page-menu w-[51.5vh] ${!data.page ? 'translate-x-[100%]' : '-translate-x-0'} ${data.display} right-0 flex flex-col divide-y divide-gray-700  bg-gray-900 border-1 border-blue-900 text-white overflow-x-hidden overflow-y-scroll  h-[92vh] fixed duration-250 transition-all`">
