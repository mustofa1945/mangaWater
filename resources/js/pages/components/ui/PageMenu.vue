...
<template>
        <div
            :class="`Page-menu fixed right-0 w-[22rem] ${
                !data.page ? 'translate-x-[100%]' : 'translate-x-0'
            } ${
                data.display
            } right-0  flex-col divide-y divide-gray-700  bg-gray-900 border-1 border-blue-900 text-white overflow-x-hidden overflow-y-scroll  h-[92dvh] duration-250 transition-all`"
        >
            <div
